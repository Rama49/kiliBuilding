...
import 'package:kiliwebsite/Component/SectionBuilding/listView5.dart';
import 'two_components_row.dart';

class BuildingComponent5 extends StatelessWidget {
  const BuildingComponent5({super.key});

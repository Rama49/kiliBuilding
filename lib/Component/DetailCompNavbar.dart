...
class DetailCompNavbar extends StatefulWidget {
  const DetailCompNavbar({Key? key, required CardNavigationData cardData}) : super(key: key);
...
class _OngletsState extends State<DetailCompNavbar> {

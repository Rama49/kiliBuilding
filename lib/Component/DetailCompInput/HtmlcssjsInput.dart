...
import 'package:kiliwebsite/Component/DetailCompInput/DetailCompInput.dart';
import 'package:kiliwebsite/Component/RenduInput/RenduInput.dart';

class HtmlcssjsInput extends StatelessWidget {
  const HtmlcssjsInput({super.key});

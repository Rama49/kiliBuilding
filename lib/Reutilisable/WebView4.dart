...
void main() {
  ...
  runApp(const MaterialApp(home: Webview4()));
}
...
class Webview4 extends StatefulWidget {
  ...
  @override
  Webview4State createState() => Webview4State();
}

class Webview4State extends State<Webview4> {
  PlatformWebViewController? _controller;
  String id = 'E9yPFBbeqOEqo7lA4Pqv'; // Remplacez avec votre ID réel
